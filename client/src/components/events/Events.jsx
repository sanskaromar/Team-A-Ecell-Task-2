        ...
        <div className="w-screen xl:py-20 sm:py-10 py-5" id="events">
            <div className='flex flex-col xl:mx-[10%] mx-[5%] xl:flex-row'>
                ...
                <div className="flex flex-wrap justify-center items-center flex-col ">
                    <motion.div className="container-1 flex flex-col sm:flex-row w-full justify-between"
                        whileInView={{ y: [50, 0], opacity: [0, 1] }}
                    ...
                    <motion.div className="conatiner-2 flex flex-col sm:flex-row w-full justify-between"
                        whileInView={{ y: [50, 0], opacity: [0, 1] }}
                        transition={{ delay: 1, duration: 0.2, ease: "easeOut" }}
                        viewport={{ once: true }}
                    >
                    ...
                    <motion.div className="conatiner-3 flex flex-col sm:flex-row w-full justify-center"
                        whileInView={{ y: [50, 0], opacity: [0, 1] }}
                        transition={{ delay: 1, duration: 0.2, ease: "easeOut" }}
                        viewport={{ once: true }}
                    >
                    ...
                    <motion.div className="conataier-4 flex flex-col sm:flex-row w-full justify-between"
                        whileInView={{ y: [50, 0], opacity: [0, 1] }}
                        transition={{ delay: 1, duration: 0.2, ease: "easeOut" }}
                        viewport={{ once: true }}
                    >

        ...
        <div className="xl:flex xl:flex-row xl:mx-40 md:mx-20 sm:mx-10 sm:flex sm:flex-col sm:items-center">
          ...
          <div className="xl: m-6 p-4 xl:bg-gray-300 xl:mx-10 xl:w-3/5 rounded-3xl display-flex  flex-wrap display-inline space-x-6 ">
           <motion.div whileInView={{ x: [-20, 20], opacity: [0, 1] }}
            ...
            whileTap={{ scale: 1.5 }}><img  className="w-40 h-40  " src={logo1} alt="baabtra.com" /></motion.div> 
           <motion.div whileInView={{ x: [-20, 20], opacity: [0, 1] }}
            transition={{ duration: 1, ease: "easeOut" }}
            whileTap={{ scale: 1.5 }}><img  className="w-40 h-30  " src={logo2} alt="loco.com" /></motion.div> 
         <motion.div whileInView={{ x: [-20, 20], opacity: [0, 1] }}
            transition={{ duration: 1, ease: "easeOut" }}
            whileTap={{ scale: 1.5 }}><img  className="w-40 h-40  " src={logo3} alt="drivezy.com" /></motion.div>   
           <motion.div whileInView={{ x: [-20, 20], opacity: [0, 1] }}
            transition={{ duration: 1, ease: "easeOut" }}
            whileTap={{ scale: 1.5 }}><img  className="w-40 h-30  " src={logo4} alt="EveryCrave.com" /></motion.div> 
           <motion.div whileInView={{ x: [-20, 20], opacity: [0, 1] }}
            transition={{ duration: 1, ease: "easeOut" }}
            whileTap={{ scale: 1.5 }}><img  className="w-40 h-30  " src={logo5} alt="kratikal.com" /></motion.div> 
          </div>
          <div className="m-4 p-4 xl:bg-gray-300 xl:mx-10 xl:w-3/5 rounded-3xl display-flex flex-wrap display-inline space-x-6 ">
          <motion.div  whileInView={{ x: [-20, 20], opacity: [0, 1] }}
            transition={{ duration: 1, ease: "easeOut" }}
            whileTap={{ scale: 1.5 }} ><img  className="w-40 h-30  " src={logo6} alt="symb.com" /></motion.div>
            <motion.div  whileInView={{ x: [-20, 20], opacity: [0, 1] }}
            transition={{ duration: 1, ease: "easeOut" }}
            whileTap={{ scale: 1.5 }}  ><img  className="w-40 h-40  " src={logo7} alt="trelos.com" /></motion.div>
            <motion.div  whileInView={{ x: [-20, 20], opacity: [0, 1] }}
            transition={{ duration: 1, ease: "easeOut" }}
            whileTap={{ scale: 1.5 }}  ><img  className="w-40 h-30  " src={logo8} alt="unacademy.com" /></motion.div>
           <motion.div  whileInView={{ x: [-20, 20], opacity: [0, 1] }}
            transition={{ duration: 1, ease: "easeOut" }}
            whileTap={{ scale: 1.5 }}  ><img  className="w-40 h-40  " src={logo9} alt="pvr.com" /></motion.div> 
          </div>
        </div>
      </div>
    );

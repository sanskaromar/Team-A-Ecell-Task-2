...
const Renaissance = () => {
    return (
      <div className="background-color: rgb(4 12 24);    xl:py-20 sm:py-10 " id="renaissance">
        ...
        <div className=" xl:flex xl:flex-row xl:mx-40 md:mx-20 sm:mx-10 sm:flex sm:flex-col sm:items-center">
          ...
          whileTap={{ scale: 0.9 }} className="text-6xl font-bold xl:w-2/5 sm:flex sm:flex-row sm:items-center xl:pb-20 sm:pb-10">
        ...
        <div className='xl:flex xl:flex-col xl:mx-40 md:mx-20 sm:mx-10 sm:flex sm:flex-row sm:items-center'>
          ...
          <motion.div  whileInView={{ y: [50, 0], opacity: [0, 1] }}
          transition={{ duration: 2, ease: "easeOut" }}
           whileTap={{ scale: 0.9 }} className="xl:bg-040C18 xl:mx-10 xl:w-3/5 rounded-3xl">
